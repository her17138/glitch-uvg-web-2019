      ...
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {input !== ""
            ? (
              <div style={divS}>
                <button label="button" type="button" value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} />
                <button label="button" type="button" className="fa fa-search" style={inputSearch} onClick={this.search} />
              </div>
            )
            : <button label="button" type="button" className="fa fa-search hover" /> }
        </form>
      </div>
    );
  }
